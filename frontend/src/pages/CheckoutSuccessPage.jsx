...
export default function CheckoutSuccessPage() {
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-24 text-center sm:px-6 lg:px-8">
      ...
      <h1 className="font-display mt-4 text-2xl font-semibold text-brand-900 animate-slow-text">Order Placed Successfully!</h1>
      ...
      {total > 0 && (
        <p className="mt-4 text-lg font-semibold text-brand-900 animate-slow-text" style={{animationDelay: '0.4s'}}>
